...
$watchFolder = "C:\Users\socialdemocracy\dynamic_biennio_rosso_alternate_history\source"
$repoPath = "C:\Users\socialdemocracy\dynamic_biennio_rosso_alternate_history"
